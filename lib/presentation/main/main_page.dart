      ...
      body: Stack(
        children: [
          BlocBuilder<MainPageBloc, MainPageSate>(
            ...
            final listItem = state.cities
                .map((e) => HomePage(
                      city: e,
                      isCurrentCity: e == state.cities.first,
                    ))
                .toList();
            return PageView(
          ...
          BlocBuilder<MainPageBloc, MainPageSate>(
              ...
              builder: (context, state) {
                controller =
                    TabController(length: state.cities.length, vsync: this);
                return Visibility(
            ...
            return Positioned(
              ...
              child: Row(
                children: [
                  IconButton(
                      onPressed: () {
                        navigation.navigateTo(AppRouter.city).then((value) {
                          if (value != null) {
                  ...
                  IconButton(
                      ...
                      icon: Icon(Icons.settings,
                          color:
                              !isDay ? Color(0xfffafafa) : Color(0xff1D212C)))
                ],
              ),
            );
          })
